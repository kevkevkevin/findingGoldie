...
var resultCompleteText = 'STAGE[LEVEL] COMPLETE:\nYou found GOLDIE! in [TIME]!'; //result complete text
var resultFailText = 'GAME OVER:\nYou failed to find GOLDIE! you piece of SH**'; //result fail text
var puzzleFileName = 'findingGOLDIE'; //download puzzle photo filename
...
var shareTitle = 'I found GOLDIE in [SCORE]!';//social share score title
var shareMessage = 'Hey I found GOLDIE in [SCORE] on Find GOLDIE game! Challenge me now!'; //social share score message
...
function share(action){
	...
	if( action == 'twitter' ) {
		...
		shareurl = 'mailto:?subject=Can you find GOLDIE? &amp;body=Check out this site http://www.findGOLDIE.xyz'+loc;
	}
